    ...
    <section className="hero-section relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden px-4 pt-28 pb-24 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <div className="text-center lg:text-left">
          <div className="animate-fade-up inline-flex items-center gap-2 rounded-full border border-[var(--color-primary)]/35 bg-[var(--color-primary-muted)] px-4 py-2 text-sm font-medium text-[var(--color-primary)] opacity-0 animate-delay-1 lg:inline-flex">
          ...
          <h1 className="animate-fade-up mt-6 font-display text-4xl font-bold leading-[1.08] tracking-tight text-white opacity-0 sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl animate-delay-2">
          ...
          <p className="animate-fade-up mx-auto mt-5 max-w-xl text-base text-[var(--color-muted)] opacity-0 sm:text-lg animate-delay-3 lg:mx-0">
          ...
          <p className="animate-fade-up mt-5 text-center text-sm text-[var(--color-muted)] opacity-0 animate-delay-4 lg:text-left">
        ...
        <div className="animate-fade-up relative mx-auto w-full max-w-lg opacity-0 animate-delay-2 lg:max-w-none">
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-[var(--color-border)]/50 bg-[var(--surface)] shadow-2xl ring-1 ring-white/5">
            <Image
              src={src}
              alt={alt}
              fill
            ...
            />
            <div
              className="pointer-events-none absolute inset-0 bg-gradient-to-tr from-[var(--color-primary)]/25 via-transparent to-[var(--color-accent)]/15"
              aria-hidden
            />
          </div>
        </div>
