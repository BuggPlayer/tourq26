    ...
    <>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <div className="space-y-2">
          <label className="text-sm font-medium text-muted-foreground">{mode === "encode" ? "Plain text" : "Base58"}</label>
          <textarea
            value={input}
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-muted-foreground">{mode === "encode" ? "Base58" : "Plain text"}</label>
          <textarea
            readOnly
            value={output}
            rows={14}
